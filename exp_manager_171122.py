...
import nn_shson_171121 as nn_shson
...
class exp_manager(object):
    ...
    def train(self, name_train, n_epochs, patience = 3, vdec_range = 20, supgrad = False, update_prior = True, reset_q_params = False, fs_decay = False, fs_range = 25):
        ...
        colors = ['b', 'g', 'r', 'c']
        legends = list()
        plt.title("Valid performances, " + self.name_dir) ## TODO
        for i in range(n_datas):
            if i < 3:
        ...
        plt.title("Averaged performance, " + self.name_dir) ## TODO
